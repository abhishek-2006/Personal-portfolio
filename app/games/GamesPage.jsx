    ...
    >
      <div className="h-full rounded-4xl backdrop-blur-md p-8 flex flex-col border border-white/5 min-h-105 bg-gradient-to-br from-cyan-950/20 to-purple-950/10">
        ...
        >
          ...
          <Layers className="text-white/10 w-12 h-12 -mr-4 -mt-4 group-hover:text-white/15 transition-colors duration-500" />
        </motion.div>

        <motion.h2
          className="text-2xl font-bold mb-3 text-white group-hover:text-cyan-400 transition-colors drop-shadow-lg"
...
export default function GamesPage({ initialGames }) {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const processedGames = githubData
          .map(repo => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-white pt-24 pb-20 px-6 relative overflow-hidden selection:bg-cyan-500/30">
      ...
      {/* Background Aesthetic Glows - Enhanced 3D Animations */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        {/* Main Cyan Glow - 3D Rotating */}
        <motion.div
          className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[radial-gradient(circle,rgba(37,99,235,0.2)_0%,transparent_70%)]"
          animate={{
            y: [0, -30, 0],
            x: [0, 20, 0],
            scale: [1, 1.1, 1],
        ...
        <motion.div
          className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[radial-gradient(circle,rgba(147,51,234,0.2)_0%,transparent_70%)]"
          animate={{
            y: [0, 30, 0],
            x: [0, -20, 0],
            scale: [1, 1.15, 1],
        ...
        <motion.div
          className="absolute top-1/2 right-1/4 w-[40%] h-[40%] rounded-full bg-[radial-gradient(circle,rgba(34,211,238,0.15)_0%,transparent_70%)]"
          animate={{
            y: [0, 40, -20, 0],
            x: [0, -30, 40, 0],
        ...
        <motion.div
          className="absolute bottom-1/4 left-1/3 w-[35%] h-[35%] rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.12)_0%,transparent_70%)]"
          animate={{
            y: [0, -50, 20, 0],
            x: [0, 40, -30, 0],
            scale: [1, 0.9, 1.1, 1],
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="flex flex-col items-center text-center mb-16" style={{ perspective: 1200 }}>
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-black py-4 text-center bg-linear-to-r from-white via-cyan-100 to-blue-400 bg-clip-text text-transparent leading-none drop-shadow-2xl"
            style={{
              perspective: 1000,
