...
const siteConfig = {
  ...
  keywords: [
    ...
    "Abhishek Badola Portfolio Vercel",
    "Abhishek Jain Portfolio Vercel",
    ...
    "Abhishek Badola TicTacToe",
    "Abhishek Jain TicTacToe",
    "Abhishek Shah Chess",
    "Abhishek Shah Chess Game",
    "Abhishek Badola Chess",
    "Abhishek Jain Chess",
    "Abhishek Badola Games",
    "Abhishek Jain Games",
    "Abhishek Shah Bardoli",
    "Bardoli", 
    "Gujarat"
  ],
};
